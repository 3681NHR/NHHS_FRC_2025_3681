    ...
    public RobotContainer() {
        ...
        driverSticks = new duelJoystickAxis(
                () -> lxLim.calculate(ExtraMath.processInput(
                        Joystick.deadzone(Constants.OperatorConstants.LEFT_DEADBAND,
                                ...
                                .getX(),
                        -1.0 * ExtraMath.remap(superstructure.wantedState == WantedSuperState.CLIMB
                                ? driverController.getRawAxis(LEFT_TRIGGER)
                                : 0, 0, 1.0, 1.0, 0.1),
                ...
                () -> rxLim.calculate(ExtraMath.processInput(
                        Joystick.deadzone(Constants.OperatorConstants.RIGHT_DEADBAND,
                                ...
                                .getX(),
                        -0.75 * ExtraMath.remap(superstructure.wantedState == WantedSuperState.CLIMB
                                ? driverController.getRawAxis(RIGHT_TRIGGER)
                                : 0, 0, 1.0, 1.0, 0.1),
        ...
        switch (Constants.MODE) {
            ...
            case SIM:
                ...
                vision = new Vision(
                        e,
                        new CameraIOPhotonSim(e, VisionConstants.CAMERA_NAMES[0], VisionConstants.BL_ROBOT_TO_CAM,
                                driveSim::getSimulatedDriveTrainPose),
                        new CameraIOPhotonSim(e, VisionConstants.CAMERA_NAMES[2], VisionConstants.BR_ROBOT_TO_CAM,
                                driveSim::getSimulatedDriveTrainPose),
                        new CameraIOPhotonSim(e, VisionConstants.CAMERA_NAMES[1], VisionConstants.FL_ROBOT_TO_CAM,
                                driveSim::getSimulatedDriveTrainPose));
                if (driveSim != null) {
                    drive = new Drive(
            ...
            default:
                ...
                affector = new Affector(new ElevatorIO() {
                }, new WristIO() {
                }, operatorController);
