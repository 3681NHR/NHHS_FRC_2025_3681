...
public class WristConstants {
    ...
    public static final PIDGains.ProfiledPID POS_PID_SIM = new PIDGains.ProfiledPID(0, 0, 0, 8, 17);
    public static final PIDGains.GravityFF POS_FF_SIM = new PIDGains.GravityFF(0.2, 0.356, 0.0, 0);
